          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form method="post">
              ...
              <div class="form-outline mb-3">
                <input type="password" id="passwUser" class="form-control form-control-lg"
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                <button type="button" class="btn btn-primary btn-lg"
                  style="padding-left: 2.5rem; padding-right: 2.5rem;" id="btnLoginUser">Login</button>
                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                    class="link-danger" data-toggle="modal" data-target="#loginRegisterModal">Register</a></p>
              </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Nuevo usuario para login</h5>
          ...
          <div class="modal-body">
           ...
           <div class="form-group">
             <input type="email" class="form-control" id="useremail" placeholder="correo"/>
           </div>
           <div class="form-group">
             <input type="password" class="form-control" id="passworduser" placeholder="contraseña"/>
           </div>
           <div class="form-group">
             <input type="password" class="form-control" id="passworduser2" placeholder="confirma contraseña"/>
           </div>
           <div class="form-group">
             <select class="form-control" id="selecttypeuser">
